...
const cards = ref(JSON.parse(localStorage.getItem(STORAGE_KEY) || "[]"));
const sortList = ref({
  "По цене min": sortPriceMin,
  "По цене max": sortPriceMax,
  "По наименованию": sortTitle,
});
